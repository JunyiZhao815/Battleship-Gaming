...
public class CoordinateTest {
  ...
  public void test_getRow() {
    Coordinate c1 = new Coordinate(1, 2);
    assertEquals(c1.getRow(), 1); // equals should be reflexsive
    assertNotEquals(c1.getRow(), 2);
  }
  @Test
  public void test_getColumn() {
    Coordinate c1 = new Coordinate(1, 2);
    assertEquals(c1.getColumn(), 2); // equals should be reflexsive
    assertNotEquals(c1.getColumn(), 1);
  }
  @Test
  public void test_toString() {
    ...
    assertNotEquals(c3.toString(), "(1, 2)");
  }
