 ...
 */
public class BattleShipShape<T> extends BasicShip<T> {
   ...
   * of initialization.
   */
  public BattleShipShape(String name, Coordinate upperLeft, ShipDisplayInfo<T> sdi,
      ShipDisplayInfo<T> enemyDisplayInfo, Character orientation) {
    super(makeCoords(upperLeft, orientation), sdi, enemyDisplayInfo);
    this.name = name;
  }

  public BattleShipShape(String name, Coordinate upperLeft, T data, T onHit, Character orientation) {
    this(name, upperLeft, new SimpleShipDisplayInfo<T>(data, onHit),
        new SimpleShipDisplayInfo<T>(null, data), orientation);
  }

  public BattleShipShape(Coordinate upperLeft, T data, T onHit, Character orientation) {
  ...
  /**
   * This function get the name of this ship
   * 
