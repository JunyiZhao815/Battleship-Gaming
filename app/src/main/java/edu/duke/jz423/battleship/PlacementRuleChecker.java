...
/**
   This class is the rule checker that checks many ruls, and it is the parent class of many rule checker classes.
 */
public abstract class PlacementRuleChecker<T> {
  ...
  /**
     ...
     @param theShip: it is the ship that may follow or against the rule on the board
     @param theBoard: it is the board
     @return what it returns is true or false that the ship follows the placement rule
   */
